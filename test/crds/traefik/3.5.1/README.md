...
- For strict schema validation pinned to an official tag (v3.5.1), run `hack/scripts/update-traefik-crds.sh` to replace these stubs with upstream CRDs byte-for-byte.
